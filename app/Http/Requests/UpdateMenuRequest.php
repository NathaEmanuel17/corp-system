...
class UpdateMenuRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'route_get'    => 'required|unique:menus,route_get,' . $this->route()->menu,
            'route_post'   => 'nullable|unique:menus,route_post,' . $this->route()->menu,
            'route_put'    => 'nullable|unique:menus,route_put,' . $this->route()->menu,
            'route_delete' => 'nullable|unique:menus,route_delete,' . $this->route()->menu,
        ];
    }
